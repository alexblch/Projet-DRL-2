...
class REINFORCEWithBaselineAgent:
    def __init__(self, env, learning_rate=0.001, gamma=0.99):
        ...
        self.gamma = gamma
        self.model_path = "models/reinforce_with_baseline.h5"
        ...
        self.policy_model_path = "models/Reinforce_baseline/reinforce_with_baseline.h5"
        self.critic_model_path = "models/Reinforce_baseline/critic_model.h5"
